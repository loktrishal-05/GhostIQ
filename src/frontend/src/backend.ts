...
import type { FrontendUserProfile as _FrontendUserProfile, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deleteAnalysis(arg0: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getCallerUserProfile(): Promise<FrontendUserProfile | null> {
        if (this.processError) {
            try {
    ...
    async getHistory(): Promise<Array<AnalysisRecord>> {
        if (this.processError) {
            try {
    ...
    async getUserProfile(arg0: Principal): Promise<FrontendUserProfile | null> {
        if (this.processError) {
            try {
    ...
    async saveCallerUserProfile(arg0: FrontendUserProfile): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FrontendUserProfile]): FrontendUserProfile | null {
